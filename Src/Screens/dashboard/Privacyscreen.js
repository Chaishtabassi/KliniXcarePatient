...
const Privacyscreen = ({navigation}) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('https://espinarealty.com/doctor/api/fetchprivacypolicy', {
          method: 'POST',
        });
...
3. Application refers to Espina Medical Clinics Powered By KliniXKare, the software program provided by the Company.

4. Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Teleforce Technologies, 8th Floor & 1103-1104, Park Centrale Building, IT Park, Apas, Cebu City, Philippines-6000.

5. Country refers to: Philippines
...
1. Pictures and other information from your Device's camera and photo library
...
2. With Affiliates: We may share Your information with Our affiliates, in which case we will require those affiliates to honor this Privacy Policy. Affiliates include Our parent company and any other subsidiaries, joint venture partners or other companies that We control or that are under common control with Us.

3. With business partners: We may share Your information with Our business partners to offer You certain products, services or promotions.
...
2. By email: info@klinixkare.com

By visiting this page on our website: http://klinixkare.com/contact.html`
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <View style={{ padding: 10 }}>
        ...
        <Text style={{ fontSize: 14, color: 'black', marginTop: 10 }}>{privacyPolicyText}</Text>
      </View>
    </View>
    </ScrollView>
  )
